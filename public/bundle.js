...
var App = function (_a) {
    var size = useWindowResize_1.default(200).size;
...
var throttle_1 = __importDefault(__webpack_require__(/*! lodash/throttle */ "./node_modules/lodash/throttle.js"));
...
var useWindowResize = function (throttleTime) {
    var _a = react_1.useState(getWindowSize()), size = _a[0], setSize = _a[1];
    var handleResize = react_1.useCallback(throttle_1.default(function () { return setSize(getWindowSize()); }, throttleTime), [setSize]);
